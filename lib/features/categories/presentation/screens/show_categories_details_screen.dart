...
import 'package:shop_now/features/categories/presentation/widgets/show_categories_details_widget.dart';

class ShowCategoriesDetailsScreen extends StatelessWidget {
  final int id;
  const ShowCategoriesDetailsScreen({Key? key,required this.id}) : super(key: key);
          ...
          return Scaffold(
            ...
            body: ConditionalBuilder(
              ...
              builder: (context) => ListView.separated(
                itemBuilder: (context, index) => ShowCategoriesDetailsWidgets(dataDetailsItem: cubit.categoriesDataDetails!.data[index]),
