...
int current =0;
class ShowCategoriesDetailsWidgets extends StatefulWidget {
  final DataDetailsItem dataDetailsItem;

  const ShowCategoriesDetailsWidgets({Key? key, required this.dataDetailsItem})
      : super(key: key);

  @override
  State<ShowCategoriesDetailsWidgets> createState() => _ShowCategoriesDetailsWidgetsState();
}

class _ShowCategoriesDetailsWidgetsState extends State<ShowCategoriesDetailsWidgets> {
  @override
