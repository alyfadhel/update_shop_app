...
class GetFavoritesUseCae extends BaseUseCase<List<FavoriteDataDetails>,NoParameters>
{
  final BaseFavoritesRepository baseFavoritesRepository;

  GetFavoritesUseCae(this.baseFavoritesRepository);
  @override
  Future<Either<Failure, List<FavoriteDataDetails>>> call(NoParameters parameters)async {
